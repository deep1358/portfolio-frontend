...
const BasePage = ({
  ...
  header,
  className = "",
  title = "Portfolio - Deep Shah",
  metaDescription = "My name is Deep Shah and I am Web developer and I am great learner.I am a currently in LDCE and pursuing Bachelor's degree in Computer Engineering. I have experience in Web developement.",
  canonicalPath,
  indexPage,
  noWrapper,
}) => {
